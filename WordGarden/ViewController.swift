...
//  WordGarden
//
//  Created by Chloe Chen on 9/13/21.
//
...
class ViewController: UIViewController {
    ...
    func formatRevealedWord() {
        ...
        for letter in wordToGuess {
            // check if letter in wordToGuess is in lettersGuessed (i.e. did you get this letter already?)
    ...
    func guessALetter() {
        ...
        // Check to see if you've played all the words. If so, update the message indicated the player can restart the game.
